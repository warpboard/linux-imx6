...
/*!
 * @defgroup Framebuffer Driver
 */

/*!
 * @file mxcfb_lh154.c
 *
 * @brief MXC Frame buffer driver for LH154
 *
 * @ingroup Framebuffer
 */
...
/*!
 * platform driver structure for LH154
 */
...
static int __init lh154_lcd_init(void)
{
	return platform_driver_register(&lcd_driver);
}

static void __exit lh154_lcd_exit(void)
{
	platform_driver_unregister(&lcd_driver);
}

late_initcall(lh154_lcd_init);
module_exit(lh154_lcd_exit);

MODULE_AUTHOR("Revolution Robotics, Inc.");
MODULE_DESCRIPTION("LH154 LCD init driver");
MODULE_LICENSE("GPL");
