/*
 * MAX77696 Linear Regulators Driver
 *
...
#define LDO_VREG_DESC(_id, _name, _cnfg1_reg, _cnfg2_reg, _min, _max, _step) \
...
static struct max77696_ldo_vreg_desc max77696_ldo_vreg_descs[LDO_NREG] = {
    LDO_VREG_DESC(L1,  "ldo1",  L01_CNFG1, L01_CNFG2,  800000, 3950000, 50000),
    LDO_VREG_DESC(L2,  "ldo2",  L02_CNFG1, L02_CNFG2,  800000, 3950000, 50000),
    LDO_VREG_DESC(L3,  "ldo3",  L03_CNFG1, L03_CNFG2,  800000, 3950000, 50000),
    LDO_VREG_DESC(L4,  "ldo4",  L04_CNFG1, L04_CNFG2,  800000, 2375000, 25000),
    LDO_VREG_DESC(L5,  "ldo5",  L05_CNFG1, L05_CNFG2,  800000, 2375000, 25000),
    LDO_VREG_DESC(L6,  "ldo6",  L06_CNFG1, L06_CNFG2,  800000, 3950000, 50000),
    LDO_VREG_DESC(L7,  "ldo7",  L07_CNFG1, L07_CNFG2,  800000, 3950000, 50000),
    LDO_VREG_DESC(L8,  "ldo8",  L08_CNFG1, L08_CNFG2,  800000, 2375000, 25000),
    LDO_VREG_DESC(L9,  "ldo9",  L09_CNFG1, L09_CNFG2,  800000, 2375000, 25000),
    LDO_VREG_DESC(L10, "ldo10", L10_CNFG1, L10_CNFG2, 2400000, 5550000, 50000),
};
